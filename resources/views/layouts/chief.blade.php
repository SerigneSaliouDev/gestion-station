...
<head>
    ...
    <title>@yield('title', config('app.name', 'Laravel')) - Chief</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark chief-bg-primary">
        <!-- Logo -->
        <a href="{{ route('chief.dashboard') }}" class="navbar-brand">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="{{ route('chief.validations') }}" class="dropdown-item">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    <i class="far fa-user"></i> {{ Auth::user()->name ?? 'Chief' }}
                    <i class="fas fa-caret-down ml-1"></i>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <div class="dropdown-header text-center">
                        <strong>{{ Auth::user()->name ?? 'Chief' }}</strong><br>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="{{ route('chief.dashboard') }}" class="brand-link">
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">{{ Auth::user()->name ?? 'Chief' }}</a>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    <!-- Dashboard -->
                    <li class="nav-item">
                        <a href="{{ route('chief.dashboard') }}" class="nav-link {{ request()->routeIs('chief.dashboard') ? 'active' : '' }}">
                    ...
                    <!-- Validations -->
                    <li class="nav-item">
                        <a href="{{ route('chief.validations') }}" class="nav-link {{ request()->routeIs('chief.validations*') ? 'active' : '' }}">
                    ...
                    <!-- Stations -->
                    <li class="nav-item">
                        <a href="{{ route('chief.stations') }}" class="nav-link {{ request()->routeIs('chief.stations*') ? 'active' : '' }}">
                    ...
                    <!-- Rapports -->
                    <li class="nav-item has-treeview {{ request()->routeIs('chief.rapports*') || request()->is('pdf/*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->routeIs('chief.rapports*') || request()->is('pdf/*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <!-- Rapports Standards -->
                            <li class="nav-item">
                                <a href="{{ route('chief.rapports.stations') }}" class="nav-link {{ request()->routeIs('chief.rapports.stations') ? 'active' : '' }}">
                                    <i class="far fa-chart-bar nav-icon"></i>
                                    <p>Rapport Stations</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('chief.rapports.pompistes') }}" class="nav-link {{ request()->routeIs('chief.rapports.pompistes') ? 'active' : '' }}">
                            ...
                            <!-- Page principale PDF -->
                           <li class="nav-item">
                                <a href="{{ route('pdf.station.report', ['stationId' => $stationId ?? 'null']) }}" 
                                class="nav-link {{ request()->routeIs('pdf.station.report') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview" style="margin-left: 15px;">
                                    <!-- Rapport Station -->
                                    <li class="nav-item">
                                        <a href="{{ route('pdf.station.report') }}" 
                                           class="nav-link pdf-link {{ request()->routeIs('pdf.station.report') ? 'active' : '' }}"
                                           target="_blank">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('pdf.reconciliation.report') }}" 
                                           class="nav-link pdf-link {{ request()->routeIs('pdf.reconciliation.report') ? 'active' : '' }}"
                                           target="_blank">
                                    ...
                                    <!-- Rapport Inventaire -->
                                    <li class="nav-item">
                                        <a href="{{ route('pdf.inventory.report') }}" 
                                           class="nav-link pdf-link {{ request()->routeIs('pdf.inventory.report') ? 'active' : '' }}"
                                           target="_blank">
                                    ...
                                    <!-- Ventes par Pompiste -->
                                    <li class="nav-item">
                                        <a href="{{ route('pdf.sales-by-pump.report') }}" 
                                           class="nav-link pdf-link {{ request()->routeIs('pdf.sales-by-pump.report') ? 'active' : '' }}"
                                           target="_blank">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">
                            <i class="fas @yield('page-icon', 'fa-tachometer-alt') mr-2 chief-text-primary"></i>
                            @yield('page-title', 'Tableau de Bord Chief')
                        </h1>
                        <small class="text-muted">@yield('page-subtitle', 'Interface de supervision des opérations')</small>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('chief.dashboard') }}">Chief</a></li>
                            @yield('breadcrumb')
                        </ol>
                    </div>
                </div>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; {{ date('Y') }} ODYSSEE ENERGIE SA - Interface Chief.</strong> Tous droits réservés.
        <div class="float-right d-none d-sm-inline-block">
            <b>Version</b> 1.0.0 | <span id="currentTime">{{ date('H:i') }}</span>
        </div>
    </footer>
</div>
