...
@section('page-subtitle', 'Liste et supervision des stations de carburant')
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    {{-- SUPPRIMEZ ou COMMENTEZ le bouton d'ajout --}}
                    {{-- <a href="{{ route('chief.stations.create') }}" class="btn btn-success btn-sm ml-2">
                        <i class="fas fa-plus"></i> Ajouter une station
                    </a> --}}
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    {{-- Gardez seulement les actions de visualisation --}}
                                    <a href="{{ route('chief.stations.show', $station->id) }}" 
                                       class="btn btn-info" title="Voir détails">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    {{-- SUPPRIMEZ les boutons d'édition et suppression --}}
                                    {{-- <a href="{{ route('chief.stations.edit', $station->id) }}" 
                                    ...
                                    <a href="{{ route('chief.dashboard', ['station_id' => $station->id]) }}" 
                                       class="btn btn-secondary" title="Dashboard">
