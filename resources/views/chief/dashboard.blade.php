...
@section('title', 'Dashboard Chief')
@section('page-icon', 'fa-tachometer-alt')
@section('page-title', 'Tableau de Bord')
@section('page-subtitle', 'Vue d\'ensemble des opérations - Données en temps réel')
...
<div class="row">
    ...
    <div class="col-lg-3 col-6 mb-3 d-flex align-items-stretch">
        <div class="small-box bg-warning stats-card w-100">
            <div class="inner">
                <h3 class="font-weight-bold display-4">{{ $pendingValidationsCount ?? 0 }}</h3>
                <p class="mb-0 text-uppercase font-weight-bold">Validations en attente</p>
            </div>
            <div class="icon">
                <i class="fas fa-clock stats-icon"></i>
            </div>
            <a href="{{ route('chief.validations') }}" class="small-box-footer d-block text-center py-2 bg-dark bg-opacity-25">
    ...
    <div class="col-lg-3 col-6 mb-3 d-flex align-items-stretch">
        <div class="small-box bg-info stats-card w-100">
            <div class="inner">
                <h3 class="font-weight-bold display-4">{{ $activeStationsCount ?? 0 }}</h3>
                <p class="mb-0 text-uppercase font-weight-bold">Stations actives</p>
            </div>
            <div class="icon">
                <i class="fas fa-gas-pump stats-icon"></i>
            </div>
            <a href="{{ route('chief.stations') }}" class="small-box-footer d-block text-center py-2 bg-dark bg-opacity-25">
    ...
    <div class="col-lg-3 col-6 mb-3 d-flex align-items-stretch">
        <div class="small-box bg-primary stats-card w-100">
            <div class="inner">
                <h3 class="font-weight-bold display-4">{{ number_format($todaySales ?? 0, 0, ',', ' ') }}</h3>
            ...
            <a href="{{ route('chief.rapports.stations') }}" class="small-box-footer d-block text-center py-2 bg-dark bg-opacity-25">
    ...
    <div class="col-lg-3 col-6 mb-3 d-flex align-items-stretch">
        <div class="small-box bg-teal stats-card w-100">
            <div class="inner">
                <h3 class="font-weight-bold display-4">{{ number_format($stats['avg_ecart'] ?? 0, 0, ',', ' ') }}</h3>
...
<div class="row mt-3">
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 mb-3 d-flex align-items-stretch">
        <div class="small-box bg-secondary stats-card w-100">
            <div class="inner">
                <h3 class="font-weight-bold display-4">{{ $stats['total_shifts_today'] ?? 0 }}</h3>
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 mb-3 d-flex align-items-stretch">
        <div class="small-box bg-purple stats-card w-100">
            <div class="inner">
                <h3 class="font-weight-bold display-4">{{ $stats['total_shifts_month'] ?? 0 }}</h3>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 mb-3 d-flex align-items-stretch">
        <div class="small-box bg-orange stats-card w-100">
            <div class="inner">
                <h3 class="font-weight-bold display-4">{{ number_format($stats['total_sales_month'] ?? 0, 0, ',', ' ') }}</h3>
            ...
            <div class="card-body py-2">
                <div class="d-flex justify-content-center align-items-center flex-wrap">
                    ...
                    <span class="badge badge-warning p-2 mr-2" style="min-width: 120px; font-size: 0.9rem;">
                        <i class="fas fa-clock mr-1"></i> En attente: <strong>{{ $shiftsByStatus['en_attente'] ?? 0 }}</strong>
                    </span>
                    <span class="badge badge-success p-2 mr-2" style="min-width: 120px; font-size: 0.9rem;">
                        <i class="fas fa-check mr-1"></i> Validé: <strong>{{ $shiftsByStatus['valide'] ?? 0 }}</strong>
                    </span>
                    <span class="badge badge-danger p-2" style="min-width: 120px; font-size: 0.9rem;">
                        <i class="fas fa-times mr-1"></i> Rejeté: <strong>{{ $shiftsByStatus['rejete'] ?? 0 }}</strong>
                    </span>
                </div>
            </div>
        </div>
...
<div class="row mb-3">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('chief.dashboard') }}" id="stationFilterForm">
                    <div class="form-row align-items-center">
                        <div class="col-md-5 mb-2">
                            ...
                            <select name="station_id" id="station_id" class="form-control" style="min-width: 250px;">
                                ...
                                @if(isset($allStations) && $allStations->count() > 0)
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            @if(request('station_id') || (isset($selectedStation) && $selectedStation))
                                <a href="{{ route('chief.dashboard') }}" class="btn btn-secondary ml-2">
                                    <i class="fas fa-times"></i> Effacer le filtre
                                </a>
                            @endif
                        </div>
                        
                        @if(isset($selectedStation) && $selectedStation)
                        <div class="col-md-4 mb-2">
                            <div class="alert alert-info mb-0 p-2">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-gas-pump mr-2 fa-lg"></i>
                                    <div>
                                        <strong class="d-block">{{ $selectedStation->nom }}</strong>
                                        <small class="text-muted">
                                            Code: {{ $selectedStation->code }} | 
                                            Manager: {{ $selectedStation->manager->name ?? 'Non assigné' }}
                                        </small>
                                    </div>
                                </div>
                            </div>
...
@if(isset($stationSpecificData) && isset($selectedStation) && $selectedStation)
<div class="row mb-3">
    <div class="col-12">
        <div class="card border-primary">
            <div class="card-header bg-primary text-white">
                <h3 class="card-title">
                    ...
                    Données détaillées - {{ $selectedStation->nom }}
            ...
            <div class="card-body">
                        ...
                        <div class="info-box bg-primary w-100">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number font-weight-bold">
                                    {{ number_format($stationSpecificData['today_sales'], 0, ',', ' ') }}
                                </span>
                                <small>FCFA</small>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 mb-3 d-flex align-items-stretch">
                        <div class="info-box bg-warning w-100">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number font-weight-bold">
                                    {{ $stationSpecificData['pending_validations'] }}
                                </span>
                    ...
                    <div class="col-md-3 col-sm-6 mb-3 d-flex align-items-stretch">
                        <div class="info-box bg-success w-100">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number font-weight-bold">
                                    {{ number_format($stationSpecificData['total_sales_month'], 0, ',', ' ') }}
                                </span>
                                <small>FCFA</small>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 mb-3 d-flex align-items-stretch">
                        <div class="info-box bg-info w-100">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number font-weight-bold">
                                    {{ number_format($stationSpecificData['avg_ecart'], 0, ',', ' ') }}
                                </span>
                                <small>FCFA</small>
                            </div>
                        </div>
                ...
                @if(isset($stationSpecificData['recent_shifts']) && $stationSpecificData['recent_shifts']->count() > 0)
                <div class="row mt-3">
                    <div class="col-12">
                        <h5><i class="fas fa-history mr-2"></i> Derniers Shifts - {{ $selectedStation->nom }}</h5>
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                ...
                                <tbody>
                                    @foreach($stationSpecificData['recent_shifts'] as $shift)
                                        @php
                                            $statusBadge = [
            ...
            <div class="card-footer text-center">
                <a href="{{ route('chief.rapports.stations', ['station_id' => $selectedStation->id]) }}" 
...
@if(isset($allStations))
    ...
    @if($stationA && (!isset($selectedStation) || (isset($selectedStation) && $selectedStation->code != 'A')))
    <div class="row mb-4">
        <div class="col-12">
            <div class="card card-warning">
                <div class="card-header bg-warning">
                    <h3 class="card-title">
                        ...
                        <strong>Station Pilote A - {{ $stationA->nom }}</strong>
                    </h3>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-3 col-sm-6 mb-3 d-flex align-items-stretch">
                            <div class="info-box bg-success w-100">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">VENTES CE MOIS</span>
                                    <span class="info-box-number font-weight-bold">
                                        {{ number_format($totalSalesMonthA, 0, ',', ' ') }}
                                    </span>
                                    <small>FCFA</small>
                                </div>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <a href="{{ route('chief.dashboard', ['station_id' => $stationA->id]) }}" 
                               class="btn btn-warning btn-lg px-4 mx-2">
                                <i class="fas fa-tachometer-alt mr-2"></i> Voir dashboard Station A
                            </a>
                            <a href="{{ route('chief.rapports.stations', ['station_id' => $stationA->id]) }}" 
...
<div class="row">
    <div class="col-lg-8 mb-3 d-flex align-items-stretch">
        <div class="card w-100">
            ...
            <div class="card-body">
                @if(isset($salesLast7Days) && count($salesLast7Days) > 0)
    ...
    <div class="col-lg-4 mb-3 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <span class="badge badge-warning badge-lg">{{ $pendingValidationsCount ?? 0 }}</span>
                </div>
            </div>
            <div class="card-body p-0">
                @if(isset($recentValidations) && $recentValidations->count() > 0)
                    <ul class="nav flex-column nav-pills">
                        @foreach($recentValidations as $validation)
                            <li class="nav-item p-3 border-bottom">
                                <a href="{{ route('chief.validation.show', $validation->id) }}" class="text-decoration-none">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <strong class="d-block">{{ $validation->station->nom ?? 'Station inconnue' }}</strong>
                                            <small class="text-muted">
                                                <i class="far fa-calendar mr-1"></i>
                                                {{ $validation->date_shift->format('d/m/Y') }} - {{ $validation->shift }}
                                            </small>
                                            <br>
                                            <small class="text-muted">
                                                <i class="fas fa-user mr-1"></i>
                                                {{ $validation->user->name ?? $validation->responsable }}
                                            </small>
                                        </div>
            ...
            <div class="card-footer text-center">
                <a href="{{ route('chief.validations') }}" class="btn btn-sm btn-primary">
...
$(document).ready(function() {
    ...
    const dates = @json(array_column($salesLast7Days, 'date'));
    const totalSales = @json(array_column($salesLast7Days, 'total_sales'));
    const totalLitres = @json(array_column($salesLast7Days, 'total_litres'));
