...
<?php $__env->startSection('title', 'Jaugeage des cuves'); ?>
<?php $__env->startSection('page-title', 'Jaugeage manuel'); ?>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if(empty($tanks) || count($tanks) === 0): ?>
                    <div class="alert alert-warning" style="border-left: 4px solid #ffc107;">
                        ...
                        <a href="<?php echo e(route('manager.tanks.create')); ?>" class="alert-link" style="color: #d39e00;">
                            ...
                            <div class="card card-outline card-primary" style="border: 1px solid #FF7F00;">
                                <div class="card-header" style="background: linear-gradient(to right, #f8f9fa, #e9ecef); border-bottom: 2px solid #FF7F00;">
                                    <h4 class="card-title" style="color: #333;">
                                        <i class="fas fa-oil-can mr-2" style="color: #FF7F00;"></i>Cuve <?php echo e($tank['number']); ?>

                                        <span class="badge <?php echo e($tank['badge_class'] ?? 'badge-secondary'); ?> float-right" 
                                              style="<?php echo e($tank['badge_class'] == 'badge-danger' ? 'background-color: #FF7F00;' : 
                                                      ($tank['badge_class'] == 'badge-success' ? 'background-color: #28a745;' : 
                                                      ($tank['badge_class'] == 'badge-dark' ? 'background-color: #333;' : ''))); ?>">
                                            <?php echo e($tank['type_display'] ?? strtoupper($tank['fuel_type'] ?? 'N/A')); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3" style="background-color: #f8f9fa; padding: 10px; border-radius: 5px; border-left: 3px solid #FF7F00;">
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <strong style="color: #333;"><?php echo e(number_format($tank['capacity'] ?? 0, 0)); ?> L</strong>
                                        </div>
                                        <div class="d-flex justify-content-between mb-2">
                                            <small style="color: #666;">Stock actuel:</small>
                                            <strong style="color: #333;"><?php echo e(number_format($tank['current_volume'] ?? 0, 0)); ?> L</strong>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <small style="color: #666;">Disponible:</small>
                                            <strong style="color: #28a745;"><?php echo e(number_format(($tank['available_capacity'] ?? 0), 0)); ?> L</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between mb-1">
                                            ...
                                            <small><strong style="color: #333;"><?php echo e(number_format($tank['fill_percentage'] ?? 0, 1)); ?>%</strong></small>
                                        </div>
                                        <div class="progress progress-sm" style="height: 10px;">
                                            <div class="progress-bar bg-<?php echo e($tank['progress_class'] ?? 'info'); ?>" 
                                                 style="width: <?php echo e(min($tank['fill_percentage'] ?? 0, 100)); ?>%;
                                                        <?php echo e($tank['progress_class'] == 'danger' ? 'background-color: #dc3545;' : 
                                    ...
                                    <!-- Formulaire SIMPLE -->
                                    <form method="POST" action="<?php echo e(route('manager.tank-levels.store')); ?>" class="tank-level-form">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="card-footer" style="background-color: #f8f9fa; border-top: 2px solid #FF7F00;">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo e(route('manager.stocks.dashboard')); ?>" class="btn" 
                        ...
                        <div class="col-md-6 text-right">
                            <small class="text-muted">
                                ...
                                Total: <?php echo e(count($tanks ?? [])); ?> cuve(s) • 
                                <span style="color: #333;"><?php echo e(date('d/m/Y H:i')); ?></span>
                            </small>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    function calculateAndDisplayVolume(form) {
        ...
        if (levelCm && levelCm > 0 && levelCm <= 400) {
            ...
            $.ajax({
                url: '<?php echo e(route("manager.tank-levels.calculate-volume")); ?>',
                method: 'POST',
                data: {
                    tank_id: tankId,
                    height_cm: levelCm,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\station-gestion-app-clean\resources\views/manager/tank-levels/create.blade.php ENDPATH**/ ?>