...
<body>
    <div class="header">
        ...
        <div style="margin-top:10px;">
            <strong>Période :</strong> <?php echo e($periode ?? 'Non spécifiée'); ?> | 
            <strong>Généré le :</strong> <?php echo e(now()->format('d/m/Y H:i')); ?>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($stats['totalLitres'] ?? 0, 2, ',', ' ')); ?> L</div>
        </div>
        <div class="stat-card">
            <div style="color: #7f8c8d;">Chiffre d'Affaires</div>
            <div class="stat-value"><?php echo e(number_format($stats['totalVentes'] ?? 0, 0, ',', ' ')); ?> F CFA</div>
        </div>
        <div class="stat-card">
            <div style="color: #7f8c8d;">Dépenses</div>
            <div class="stat-value text-danger"><?php echo e(number_format($stats['totalDepenses'] ?? 0, 0, ',', ' ')); ?> F CFA</div>
        </div>
        <div class="stat-card">
            <div style="color: #7f8c8d;">Écart Global</div>
            <div class="stat-value">
                <?php $ecartFinal = $stats['totalEcartFinal'] ?? 0; ?>
                <span class="<?php echo e($ecartFinal >= 0 ? 'text-success' : 'text-danger'); ?>">
                    <?php echo e($ecartFinal >= 0 ? '+' : ''); ?><?php echo e(number_format($ecartFinal, 0, ',', ' ')); ?> F CFA
                </span>
            </div>
        </div>
    </div>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($shift->date_shift->format('d/m/Y')); ?> - <?php echo e($shift->shift); ?></td>
                <td><?php echo e($shift->responsable); ?></td>
                <td class="text-right"><?php echo e(number_format($shift->total_ventes, 0, ',', ' ')); ?></td>
                <td class="text-right"><?php echo e(number_format($shift->versement, 0, ',', ' ')); ?></td>
                <td class="text-right"><?php echo e(number_format($shift->total_depenses, 0, ',', ' ')); ?></td>
                <td class="text-right">
                    <?php $ecart = $shift->versement - ($shift->total_ventes - $shift->total_depenses); ?>
                    <span class="<?php echo e($ecart >= 0 ? 'text-success' : 'text-danger'); ?>">
...
</html><?php /**PATH C:\Users\LENOVO\station-gestion-app-clean\resources\views/pdf/shift-report.blade.php ENDPATH**/ ?>