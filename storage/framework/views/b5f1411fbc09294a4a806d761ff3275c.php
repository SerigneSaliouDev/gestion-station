    ...
    <div class="login-brand">
        <div class="brand-content">
            <div class="logo-section">
                ...
                <img src="<?php echo e(asset('adminlte/assets/img/odysse.jpg')); ?>" 
                     alt="ODYSSEE ENERGIE" 
                     class="company-logo"
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="email" name="email" id="email" class="form-control" 
                           placeholder="gerantB@odyssee.sn" required autofocus value="<?php echo e(old('email')); ?>">
...
</html><?php /**PATH C:\Users\LENOVO\station-gestion-app-clean\resources\views/auth/login.blade.php ENDPATH**/ ?>