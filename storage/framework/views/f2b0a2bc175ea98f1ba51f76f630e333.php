...
<?php $__env->startSection('title', 'Saisie Index/Ventes'); ?>
<?php $__env->startSection('page-title', 'Saisie Quotidienne des Index et Ventes'); ?>
...
<?php if(session('success')): ?>
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <?php if(session('stock_info')): ?>
            <br><br><i class="fas fa-info-circle"></i> <?php echo e(session('stock_info')); ?>
...
<form action="<?php echo e(route('manager.store_index')); ?>" method="POST" id="indexForm" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <!-- AJOUTER cette ligne -->
            <?php if(isset($station) && $station): ?>
            <div class="alert alert-info">
                <i class="fas fa-gas-pump"></i> <strong>Station:</strong> <?php echo e($station->nom); ?> - <?php echo e($station->ville); ?>

                <br><small class="text-muted">Code: <?php echo e($station->code); ?></small>
            </div>
            <?php endif; ?>
            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    ...
                    <input type="date" name="shift_date" id="shift_date" class="form-control" 
                           value="<?php echo e(old('shift_date', date('Y-m-d'))); ?>" required>
                </div>
                <div class="col-md-4 form-group">
                    <label for="shift_time">Shift</label>
                    <input type="text" name="shift_time" id="shift_time" class="form-control" 
                           value="<?php echo e(old('shift_time')); ?>" placeholder="Ex: 8H-18H ou 18H-8H" required>
                </div>
                <div class="col-md-4 form-group">
                    ...
                    <input type="text" name="responsible_name" id="responsible_name" class="form-control" 
                           value="<?php echo e(old('responsible_name')); ?>" placeholder="Nom du pompiste" required>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" step="0.01" name="pumps[<?php echo e($index); ?>][opening_index]" 
                                       value="<?php echo e(old('pumps.'.$index.'.opening_index', '0.00')); ?>" 
                            ...
                            <td>
                                <input type="number" step="0.01" name="pumps[<?php echo e($index); ?>][closing_index]" 
                                       value="<?php echo e(old('pumps.'.$index.'.closing_index', '0.00')); ?>" 
                                       class="form-control form-control-sm pump-input" 
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="number" name="cash_deposit_amount" id="cash_deposit_amount" 
                           class="form-control" value="<?php echo e(old('cash_deposit_amount', '0')); ?>" 
            ...
            return new Promise((resolve, reject) => {
                ...
                for (const [fuelType, quantity] of Object.entries(fuelQuantities)) {
                    if (quantity > 0) {
                        promises.push(
                            $.ajax({
                                url: '<?php echo e(route("manager.check-stock-for-type")); ?>',
                                type: 'POST',
                                data: {
                ...
                if (stockErrors.length > 0) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            window.location.href = '<?php echo e(route("manager.history")); ?>';
                        },
                        error: function(xhr) {
                            unlockForm();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\station-gestion-app-clean\resources\views/manager/saisie-index.blade.php ENDPATH**/ ?>