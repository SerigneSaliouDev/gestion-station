...
class SaleController extends Controller
{
    ...
    public function create()
    {
        ...
        $fuelPrices = \App\Models\FuelPrice::getCurrentPrices();
    ...
    public function store(Request $request)
    {
        ...
        $data['station_id'] = Auth::user()->station_id; // Ajouter la station
    ...
    public function index(Request $request)
    {
        ...
        // Filtrer par station pour les managers
        if ($user->isManager()) {
    ...
    public function show($id)
    {
        ...
        // Vérifier l'accès
        $user = Auth::user();
        if ($user->isManager() && $sale->station_id != $user->station_id) {
    ...
    public function cancel($id)
    {
        ...
        if ($sale->recorded_by != $user->id && !$user->isOperationsManager()) {
